  ...
  @include('admin.resume.assets.css') 
  @include('admin.resume.assets.js') 
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 text-center">
                        ...
                        <main  class="inline-tinymce-editor" style="display:none;"> Kami sudah bekerjasama dengan beberapa perusahaan </main>
    ...
    @include('admin.resume.partial.footer',["service"=>$service])
  <!-- End Footer --> 
