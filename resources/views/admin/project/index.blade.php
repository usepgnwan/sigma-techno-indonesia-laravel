...
<script>
    $(document).ready(function () { 
        let url = "{{ route('project',['opt'=>'data'])}}";
    ...
    $('.project-body').on('click','.view-content',function(e){
        e.preventDefault();
    ...
    $('.project-body').on('click','.creatData, .edit-data',function(e){
        e.preventDefault();
        let id = $(this).data('id');
        let url = "{{route('project.modal',['opt'=> ':id'])}}";
        url = url.replace(":id", id);
        $.MyModal(url, {},{
                title:  (id =='add' ? 'Tambah' : 'Edit') + ' project',
                closable: false,
                buttons: [{
                    label: 'Close', 
                    action: function(dialogItself){
    ...
    $('.project-body').on('click','.delete-data',function(e){
        let id = $(this).data('id') 
        let url ="{{ route('project.delete',['opt'=>':id']) }}";
        url = url.replace(":id", id); 
